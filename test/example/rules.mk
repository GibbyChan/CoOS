...
OPENCM3_DIR ?= /home/pluslee_linux/myproject/CoOs/CoOS/lib/libopencm3
EXAMPLE_RULES = elf
...
# EXAMPLE_DIRS:=$(sort $(dir $(wildcard $(addsuffix /*/*/Makefile,$(addprefix test/,$(TARGETS))))))
EXAMPLE_DIRS:=$(sort $(dir /home/pluslee_linux/myproject/CoOs/CoOS/test/stm32/f1/stm32-h103/miniblink/Makefile))
$(info "*****test/ rules.mk $(EXAMPLE_DIRS)*****")
